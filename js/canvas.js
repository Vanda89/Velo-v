var canvas = {
  ...
  generateCanvas: function () {
    ...
    let title = $("<h3>")
      .attr("id", "title-canvas")
      .text("Veuillez signer le canvas pour confirmer");
    ...
    canvasContainer
      .append(title, canvas, canvasController)
      .appendTo($("#stations-booked"));
  },
